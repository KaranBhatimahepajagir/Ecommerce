...
import { ArrowLeftStartOnRectangleIcon, StarIcon } from "@heroicons/react/20/solid";
         ...
         {products.map((product) => (
          <Link to={'/productDetail'}>
                ...
                <div className="mt-4 flex justify-between">
                  <div>
                    <h3 className="text-sm text-gray-700 w-44  text-ellipsis whitespace-nowrap overflow-x-hidden" >
                    ...
                    <p className="mt-1 block text-sm text-gray-500">
                      <StarIcon className="w-6 h-6 inline-block text-yellow-400"  > </StarIcon>
